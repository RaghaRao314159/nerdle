# CAMHACK SOLVER README

Files in this folder are adapted from this git repository
https://github.com/pedrokkrause/Nerdle-Equations

I have copy pasted them into the local camhack folder for easier develop
